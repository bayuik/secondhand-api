...
const { register, login, getUser, updateUser, getProducts, createProducts, deleteProducts, getDetailProduct, updateProducts, createTransactions } = require("../app/controllers");
